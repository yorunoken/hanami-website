...
export const products: readonly ProductSummary[] = [
  {
    ...
    description:
      "Profiles, recent plays, top scores, beatmaps, and performance tools inside Discord.",
  ...
  },
  {
    ...
    description:
      "Identify beatmaps from their backgrounds, audio clips, or skin screenshots.",
  ...
  },
  {
    ...
    description:
      "An early Tauri desktop prototype for reading local osu! state through tosu.",
  ...
  },
  {
    ...
    description:
      "Turn .osu files into readable reports, structured metrics, tags, and feature vectors.",
...
export const routeMetadata = {
  ...
  "/osuguessr": {
    ...
    description:
      "Identify osu! beatmaps from backgrounds, audio clips, and skin screenshots in classic or death mode.",
  },
  "/companion": {
    title: "Hanami Companion — desktop prototype",
    description:
      "Follow the early Hanami Companion desktop prototype for local osu! state tracking through tosu.",
  },
  "/map-analyzer": {
  ...
  "/legal": {
    ...
    description:
      "Privacy, terms, cookies, and data-request information for the Hanami ecosystem.",
  },
  "/legal/privacy": {
    title: "Privacy policy — Hanami",
    description:
      "How the Hanami ecosystem processes account, service, and technical data.",
  },
  "/legal/terms": {
  ...
  "/legal/cookies": {
    ...
    description:
      "Cookies and browser storage used across the Hanami ecosystem.",
  },
  "/legal/data-deletion": {
    title: "Data deletion — Hanami",
    description:
      "How account unlinking, sign-out, and data-deletion requests differ in Hanami.",
  },
  "/privacy": {
    title: "Privacy policy — Hanami",
  ...
  "/profile/privacy": {
    ...
    description:
      "Submit, track, or cancel an authenticated Hanami account deletion request.",
  },
  "/profile/privacy/confirm": {
    title: "Confirm deletion request — Hanami",
    description:
      "Confirm a Hanami account deletion request after fresh Discord authentication.",
  },
  "/login": {
