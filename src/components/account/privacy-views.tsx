      ...
      <section className={terminalPanelClass} aria-labelledby="confirm-title">
        ...
        {verifying ? (
          ...
          <>
            ...
            <p>
              This confirmation link is missing, expired, or was opened under a
              different account.
            </p>
            <PrefetchLink
              className={cn(primaryActionClass, "primary-action mt-6")}
          ...
          <form className="mt-6" onSubmit={onSubmit}>
            <p>
              This records a request for operator review across relevant Hanami
              services. It does not immediately delete every record. Some data
              may be anonymized; justified security, abuse-prevention, legal, or
              backup records may remain temporarily. Discord and osu! data
              controlled by those providers must be managed with them.
            </p>
            <p>
            ...
            <p
              ...
              className="text-[0.78rem] leading-[1.6] text-muted"
            >
              The phrase is checked by the server. Reasonable surrounding and
              repeated whitespace is normalized; the words and capitalization
...
export function RequestStatus({
  ...
  return (
    <section
      className="mt-16 border-y border-border-strong py-10 [&>p]:max-w-[68ch] [&>p]:text-[0.88rem] [&>p]:leading-[1.7] [&>p]:text-muted [&_a]:text-white [&_a]:underline-offset-[0.25em]"
    ...
    >
      ...
      <dl className="my-8 grid grid-cols-1 max-[600px]:divide-y max-[600px]:divide-border min-[601px]:grid-cols-3 min-[601px]:divide-x min-[601px]:divide-border [&>div]:py-5 min-[601px]:[&>div]:px-6 min-[601px]:[&>div:first-child]:pl-0 min-[601px]:[&>div:last-child]:pr-0 [&_dd]:mt-[0.55rem] [&_dd]:[overflow-wrap:anywhere] [&_dd]:text-[0.82rem] [&_dd]:text-[#e6e1e7] [&_dt]:font-mono [&_dt]:text-[0.68rem] [&_dt]:tracking-[0.08em] [&_dt]:text-quiet [&_dt]:uppercase">
        <div>
          <dt>Reference</dt>
      ...
      <p className="!text-[0.78rem] !leading-[1.6]">
        ...
        and include the reference if you need help.
      </p>
    </section>
  );
}
  ...
  return (
    <PrivacyShell>
      <section className={terminalPanelClass} aria-labelledby="receipt-title">
        ...
        <p>
          Your request is pending manual coordinated processing. All current
          Hanami website sessions have been revoked. Sign in again if you need
          to check or cancel it while cancellation remains available.
        </p>
        <div className="my-8 flex items-center justify-between gap-4 border-y border-border py-4">
          <code className="[overflow-wrap:anywhere] font-mono text-[1.05rem] text-accent-soft">
  ...
  return (
    <PrivacyShell>
      <AuthPanel>
        ...
        <p>
          Hanami verifies signed-in requests with Discord OAuth. If you cannot
          access the connected account, email{" "}
          <a href={`mailto:${legalContacts.privacy}`}>
            {legalContacts.privacy}
          </a>
          .
