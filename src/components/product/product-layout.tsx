...
export const productSubtitleClass =
  "mt-6 max-w-[680px] text-[clamp(1.35rem,2.3vw,2rem)] leading-[1.3] tracking-[-0.035em] text-[#e8e4e8]";
export const productBodyClass =
  "mt-[1.35rem] max-w-[62ch] text-[1.02rem] leading-7 text-muted";
export const sectionHeadingClass =
  "text-[clamp(2rem,4.2vw,3.8rem)] leading-[1.04] tracking-[-0.055em] text-white";
export const sectionBodyClass =
  "mt-5 max-w-[62ch] text-[clamp(1rem,1.4vw,1.1rem)] leading-7 text-muted";
...
export function ProductHero({
  ...
  return (
    <section
      className={cn(
        "relative min-h-[690px] overflow-hidden border-b border-border max-[820px]:min-h-0",
        className,
      )}
    >
      <div
...
export function ProductSection({
  ...
  return (
    <section
      {...props}
      className={cn(siteContainerClass, sectionSpacingClass, className)}
    >
      {children}
    </section>
  );
...
export function ProductFootnote({
  children,
  className,
}: {
  children: ReactNode;
...
export function ProductSteps({
  ...
  return (
    <ol className={cn("border-t border-border-strong", className)}>
      {children}
    </ol>
  );
}
