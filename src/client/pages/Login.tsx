  ...
  return (
    <AuthLayout>
      <AuthPanel aria-labelledby="sign-in-title">
        ...
        <p>
          Discord provides your account ID, display name, avatar, and email to
          Hanami. Sign-in is required to link an osu! account and manage bot
          preferences.
        </p>
        ...
        <p className="text-[0.78rem] [&_a]:text-white [&_a]:underline-offset-[0.2em]">
          ...
          <PrefetchLink to={routes.legalPrivacy}>privacy policy</PrefetchLink>{" "}
          first if you need more detail.
        </p>
      </AuthPanel>
    </AuthLayout>
  );
