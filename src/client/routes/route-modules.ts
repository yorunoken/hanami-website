...
const accountPrivacy = createRouteModule(
  () => import("@/client/pages/AccountPrivacy"),
);
const bot = createRouteModule(() => import("@/client/pages/Bot"));
const companion = createRouteModule(() => import("@/client/pages/Companion"));
const legalIndex = createRouteModule(
  () => import("@/components/legal/legal-index"),
);
const legalPrivacy = createRouteModule(
  () => import("@/components/legal/privacy-policy"),
);
const legalTerms = createRouteModule(() => import("@/components/legal/tos"));
const legalCookies = createRouteModule(
  () => import("@/components/legal/cookie-policy"),
);
const legalDataDeletion = createRouteModule(
  () => import("@/components/legal/data-deletion"),
);
const login = createRouteModule(() => import("@/client/pages/Login"));
const mapAnalyzer = createRouteModule(
  () => import("@/client/pages/MapAnalyzer"),
);
