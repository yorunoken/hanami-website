...
export function prefetchRoute(preload: RoutePreloader | undefined, onFailure?: () => void): void {
...
export function observeRoutePrefetch(
    ...
    preload: RoutePreloader | undefined,
    onFailure?: () => void,
    Observer: typeof IntersectionObserver | undefined = typeof IntersectionObserver === "undefined" ? undefined : IntersectionObserver,
): () => void {
