...
export default function Home() {
    ...
    return (
        <main className="flex flex-col items-center text-center justify-between px-8">
            <div className="flex flex-col text-center justify-center h-svh w-svw px-24" ref={mainRef}>
            ...
            <div className="flex flex-col text-center justify-center h-svh w-svw px-24 " ref={commandsRef}>
            ...
            <div id="support-me" className="flex flex-col text-center justify-center h-svh w-svw px-48" ref={supportMeRef}>
                ...
                <a href="https://www.buymeacoffee.com/yorunoken" target="_blank" rel="noopener noreferrer">
                    <div className="flex flex-row justify-center ring ring-special-purple hover:border-white rounded-lg p-4 transition-all">
